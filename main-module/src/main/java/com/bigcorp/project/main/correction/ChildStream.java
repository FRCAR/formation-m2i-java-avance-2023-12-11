...
public class ChildStream {
	...
	public static void main(String[] args) {
		...
		enfants.stream().forEach(c -> System.out.println(c.getNom()));
		...
		enfants.stream().mapToInt(c -> c.getAge()).average().ifPresent(System.out::println);
		...
		Child vainqueur = enfants.stream()
				.reduce(Child::joueAPierreFeuilleCiseaux)
				.get();
	...
	/**
	 * ne renverra jamais un optional si .....
	 * @param c1
	 * @param c3
	 * @param c4
	 * @return
	 */
	public Optional<Child> getPlusSportif(Child c1, Child c3, Child c4){
		///
